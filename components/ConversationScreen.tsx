...
import InsertEmotionIcon from '@mui/icons-material/EmojiEmotions';
import SendIcon from '@mui/icons-material/Send';
import MicIcon from '@mui/icons-material/Mic';
import Message from './Message';
import { addDoc, collection, doc, serverTimestamp, setDoc } from 'firebase/firestore';

const StyledRecipientsHeader = styled.div`
    position: sticky;
...
const ConversationScreen = ({ conversation, messages }: { conversation: Conversation; messages: IMessage[] }) => {
    ...
    const [messagesSnapshot, _messagesLoading, _MessagesError] = useCollection(queryGetMessages);
    ...
    const showMessages = () => {
        if (_messagesLoading) return messages.map((message) => <Message key={message.id} message={message} />);
